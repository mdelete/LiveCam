...
- (CALayer *)previewLayer {
    return self.videoCaptureSource.previewLayer;
}
...
- (void)setPixelFace:(BOOL)pixelFace {
    [self willChangeValueForKey:@"pixelFace"];
    [self.videoCaptureSource setPixelFace:pixelFace];
    [self didChangeValueForKey:@"pixelFace"];
}

- (BOOL)pixelFace {
    return self.videoCaptureSource.pixelFace;
}
...
- (void)setWatermarkImage:(CIImage *)watermarkImage {
    [self.videoCaptureSource setWatermarkImage:watermarkImage];
}

- (nullable CIImage*)watermarkImage {
    return self.videoCaptureSource.watermarkImage;
}
